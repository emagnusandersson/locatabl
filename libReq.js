...
try { eval("[a]=tmpf();");} catch(err) { alert("This browser does not support destructuring assignment with arrays:\\n"+ err); return;}
  ...
  h1.mainH1 {
    background:#ff0; box-sizing:border-box; border:solid 1px; color:black;font-size:1.6em; font-weight:bold; text-align:center;
    padding:0.4em 0em 0.4em 0em; margin:0em;  width:100%
  }
  .mainDiv {
    margin: 0em auto; height: 100%; width:100%; display:flex; flex-direction:column; max-width:var(--maxWidth)
  }
  </style>`);
...
<script type="text/javascript">
  ...
  Str.push(`<div class="viewFront mainDiv">
<div class=divEntryBar style="max-width:var(--maxWidth); min-height:2em; margin:0em auto; visibility:hidden; "></div>
<h1 class=mainH1 style="display:none">`+strH1+`</h1>
