...
FilterTitle:'Filter (remove uninteresting <span nom="vendors">vendors</span>)',
...
LoginSingUpAsVendor:'Login / Sign up as <span nom="vendor">vendor</span>',
...
FBToPreventMultipleAccounts:'Facebook is used to prevent people from creating multiple accounts (Otherwise some mischievous person could create like 100\'s of accounts and effectively sabotage the service).',
NothingIsWrittenToYourFBFlow:'Nothing is written to your Facebook flow.',
YouCanDeleteYourAccount:'You can delete your account (and all related data) at any time.',
...
introHead:'New <span nom="vendor">vendor</span>, welcome, enter obligatory info',
Tel:'Tel',
...
homeTown:'',
standingByMethod:'',
idDriverGovernment:'... from government/authority (so that customers can verify that they are dealing with a legitimate driver.',
vehicleType:'',
brand:'',
nPassengers:'',
