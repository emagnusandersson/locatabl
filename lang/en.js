...
RequestedSkills:'Requested skill',
Tools:'Tools',
...
Tools:'Tools',
RequestedVehicle:'Requested vehicle',
...
//gettingStartedLink:'Getting started as <span nom="seller">seller</span>',
...
labOrdinal:'Join now and be user number <span></span>.',

Info:'Info',
OtherJobs:'Other jobs/services...',
OtherMapApps:'Other map apps',
OtherSites:'O­th­er si­te­s',
...
nChildSeat:'Number of child seats',
nExtraSeat:'Number of extra seats',
nWheelChairPlaces:'Number of wheelchair places',
...
idOpenId:'',
terminationDate:'',
donatedAmount:'How much has the user donated to this site.',
tCreated:'How long since the account was created.',
displayName:'',
tel:'',
displayEmail:'',
...
brand:'',
nPassengers:'',
nExtraSeat:'Seats that are of lower standard than normal seats<br>Sometimes limited to persons under a certain weight/length...<br> <img>',
nChildSeat:'Equipment that changes an adult seat to one that is safer for a child<br> <img><img>',
nWheelChairPlaces:'',
currency:'',
priceStart:'',
strUnitDist:'',
