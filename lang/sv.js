...
Table:'Table',
TableC:'<span nom="Customer">Kund</span> tabell',
...
labOrdinalBC:'Du kan radera ditt konto när som helst.',

//labOrdinal:'Be the <span></span> <span nom="seller">seller</span> to join.',
headOrdinalS:'Ny <span nom="sellerRewritten">entreprenör</span>?',
headOrdinalDoubleS:'Ny entreprenör (<span nom="sellerRewritten">entreprenör</span>)?',
labOrdinalS:'Logga in nu och bli <span nom="seller">entreprenör</span> nummer <span></span>.',
labOrdinalBV:'Du kan radera ditt konto när som helst.',
...
ToggleBetweenCustomerAndSeller:'Växla mellan kunder och <span nom="sellers">entreprenör</span>',

//toManyMess:'För många <span nom="sellers">entreprenörer</span> för att lista detalier, zooma in eller använd filter för att reducera antalet under '+maxList,
...
SeeUnActivePopMess:'<p>Ingen <span nom="seller">entreprenör</span> har laddat upp sin position de senaste <span></span> timmarna.</p><p>Använd <b>Filter</b>-knappen för att inkludera äldre positioner.</p>',
...
introHead:'Ny <span nom="seller">entreprenörer</span>, välkommen!',
...
shiftEnd:'Hur länge dröjer det innan <span nom="theSeller">entreprenören</span> slutar för dagen. (Bra för kunder som vill boka i förskott)',
boShow:'',
x:'',
y:'',
imTag:'',
