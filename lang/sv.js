...
//buyerRewritten:'kund',
//sellerRewritten:'säljare',


seller:'säljare', sellers:'sälj­ar­na',
theSeller:"säljaren", theSellers:"säljarna",
theSellers0:"säljarna",
...
buyer:'köpare', buyers:'köp­are',
theBuyer:"köparen", theBuyers:"köpare",
theBuyers0:"köparna",
IndependentBuyer:'Inget lag',
...
Languages:'Kunskaper (högre nummer är bättre)',
...
ChangeMapMarkersB:'Ändra kartmarkörer för <span nom="buyer">köpare</span>',
ChangeMapMarkersS:'Ändra kartmarkörer för <span nom="seller">säljare</span>',
Prices:'Priser',
...
AppearAsBuyer:'Logga in som <span nom="buyer">köpare</span>',
AppearAsSeller:'Logga in som <span nom="seller">säljare</span>',
...
Tools:'Verktyg',
RequestedVehicle:'Önskat fordon',
...
//Compare:'&#63523,
Filter:'Filter',
FilterB:'<span nom="Buyer">Kund</span> filter',
FilterS:'Filter (<span nom="seller">entreprenör</span>)',
Table:'Table',
TableB:'<span nom="Buyer">Kund</span> tabell',
TableS:'Tabell (<span nom="Seller">entreprenör</span>)',
Filtered:'Filtrerat:',
...
headOrdinalB:'Ny <span nom="buyer">köpare</span>?',
headOrdinalDoubleB:'Ny entreprenör (<span nom="buyerRewritten">entreprenör</span>)?',
labOrdinalB:'Logga in nu och bli <span nom="buyer">köpare</span> nummer <span></span>.',

//labOrdinal:'Be the <span></span> <span nom="seller">seller</span> to join.',
headOrdinalS:'Ny <span nom="sellerRewritten">säljare</span>?',
headOrdinalDoubleS:'Ny säljare (<span nom="sellerRewritten">säljare</span>)?',
labOrdinalS:'Logga in nu och bli <span nom="seller">säljare</span> nummer <span></span>.',
...
SeeUnActivePopMess:'<p>Ingen <span nom="seller">säljare</span> har laddat upp sin position de senaste <span></span> timmarna.</p><p>Använd <b>Filter</b>-knappen för att inkludera äldre positioner.</p>',
...
noteLoginSeller:'<p>Detta är för att förhindra att folk skaffar sig mer än ett konto.<p>Din integritet har högsta prioritet. Ingen data sänds till ID utgivaren.<p>Om du är missnöjd eller bara vill testa lite så är det bara att radera ditt login. (Och du är välkommen tillbaka när som helst)',
...
CurrentlyNoOneIsVisible:'Ingen är synlig just nu',


introHead:'Ny <span nom="seller">säljare</span>, välkommen!',
...
nChildSeat:'Antal barnsäten',
nExtraSeat:'Antal extrasäten',
nWheelChairPlaces:'Antal rullstolsplatser',
standingByMethod:'Hur väntar du',
...
link:'Länk',
homeTown:'Hemstad',
standingByMethod:'Hur väntar <span nom="theSeller">säljaren</span>',
//standingByMethod:'Hur väntar säljare',
idDriverGovernment:'Förar-ID',
vehicleType:'Fordonstyp',
brand:'Märke',
nPassengers:'Antal passagerare',
nExtraSeat:'Extrasäten',
nChildSeat:'Barnsäten',
nWheelChairPlaces:'Rullstolsplatser',
currency:'Valuta',
priceStart:'Startpris',
strUnitDist:'distansenhet',
...
tAccumulated:'Ackumulerad tid som synlig',
tLastWriteOfTA:'',
hideTimer:'Döljtimer',
hideTime:'Döljs automatiskt',
comparePrice:'Järmförpris',
coordinatePrecisionM:'Koordinatprecision (±) [m]',
dist:'Avstånd',
image:'Bild',
info:'Info',
...
idOpenId:'',
terminationDate:'',
donatedAmount:'Hur mycket har användaren donerat till denna sajt.',
tCreated:'Hur länge sedan skapades kontot',
displayName:'',
tel:'',
displayEmail:'Email',
...
brand:'',
nPassengers:'',
nExtraSeat:'Säten av lägre standard än vanliga säten:<br>Ibland begränsade till personer under en viss längd/vikt...<br><img>',
nChildSeat:'Säten för att öka säkerheten för barn<br> <img><img>',
nWheelChairPlaces:'',
currency:'',
priceStart:'',
strUnitDist:'',
...
tPos:'När laddade användaren up sin position senast. (För att underlätta att sortera bort inaktiva användare.)',
...
comparePrice:'',
coordinatePrecisionM:'Om användaren inte vill att den exakta position markeras på kartan, så kan den avrundas.',
dist:'',
image:'',
info:'',
