...
(async function(){
  ...
  const handler=async function(req, res){
    ...
    var boCommon=false; //domainName===wwwCommon;
    ...
    if(boCookieDDOSCameNExist) {  var intCountT=intCount, intDDOSMaxT=intDDOSMax, timeOutDDOSBanT=timeOutDDOSBan;   }   
    else{  var intCountT=intCountIP, intDDOSMaxT=intDDOSIPMax, timeOutDDOSBanT=timeOutDDOSIPBan;   }
